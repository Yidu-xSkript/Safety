...
function Format-AlertEmail {
    ...
    switch ($Kind) {
        ...
        "NextDnsDisabled" { return @{ Subject = "[Accountability] NextDNS turned off on the PC"; Body = "This machine's DNS is no longer going through NextDNS - the porn block is OFF. The NextDNS app was likely disabled or removed. $Detail" } }
